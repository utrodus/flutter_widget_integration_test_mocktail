...
import 'package:flutter_tdd_widget_integration_test_mocktail/article_page.dart';
...
void main() {
  ...
  testWidgets(
    """
    Tapping on the first article exceprp open the article page
    where the full article contents is displayed
    """,
